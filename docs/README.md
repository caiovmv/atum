# Documentação dl-torrent

Esta documentação é voltada ao uso diário do dl-torrent: instalação, configuração, comandos e solução de problemas.
...
- [Fontes de RSS para música](rss-sources.md) — Inventário de feeds e ferramentas (TPB, 1337x, Jackett, etc.)
- [Arquitetura Netflix self-hosted (música)](arquitetura-netflix-self-hosted.md) — Fluxo descoberta → download → Plex; Spotify, Last.fm e Radar de Trend
- [Solução de problemas](troubleshooting.md) — Erros comuns e como resolver
